...
const Dashboard = ({ user, onLogout, onUserUpdate }) => {
  ...
  const handleAddEventFromDayItems = useCallback(() => {
    setShowDayItemsModal(false);
    handleOpenAddEventModal(selectedDate);
  }, [selectedDate, handleOpenAddEventModal]);
  ...
  return (
    <div className={`dashboard ${activeTab === 'calendar' ? 'calendar-active' : ''}`}>
      ...
      <DayItemsModal
        ...
        onAddEvent={handleAddEventFromDayItems}
      />
    </div>
  );
};
